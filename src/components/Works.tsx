...
const WORKS = [
  { name: "MIGHTY FC",   sport: "SOCIETY", place: "FUKUOKA", year: "2026", img: "/img/first_view.jpg",    pos: "center" },
  { name: "TOKAI-5",     sport: "FUTSAL",  place: "FUKUOKA", year: "2026", img: "/img/team_order_01.png", pos: "top" },
  { name: "CHERRY'S",    sport: "SOCCER",  place: "FUKUOKA", year: "2026", img: "/img/spec_shirt.jpg",    pos: "center" },
  { name: "SEAGULL FC",  sport: "SOCCER",  place: "KAGAWA",  year: "2025", img: "/img/spec_bibs.jpg",     pos: "center" },
  { name: "FUJITA SC",   sport: "FUTSAL",  place: "TOKYO",   year: "2025", img: "/img/spec_pants.jpg",    pos: "center" },
  { name: "BLACK BIRDS", sport: "SOCIETY", place: "OSAKA",   year: "2025", img: "/img/team_order_01.png", pos: "bottom" },
];
    ...
    <section id="works" className="stack-section relative overflow-hidden surface-paper">
      <div className="container-x section-y">
        ...
        <ul className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:mt-16 lg:grid-cols-3 lg:gap-7">
          {WORKS.map((w, i) => (
            <Reveal as="li" key={w.name} delay={(i % 3) * 80}>
              <WorkCard w={w} />
            </Reveal>
          ))}
        </ul>
    ...
    <article className="group card-lift relative h-full overflow-hidden rounded-3xl border border-[var(--color-line-ink-strong)] bg-[var(--color-paper-pure)] shadow-[0_30px_60px_-30px_rgba(0,0,0,0.25)]">
      <div className="relative aspect-[4/5] overflow-hidden bg-[var(--color-ink)]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(13,10,8,0.10) 0%, rgba(13,10,8,0) 40%, rgba(13,10,8,0.85) 100%)",
          }}
        />
